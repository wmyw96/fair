...
if args.mode == 1:
	...
	values += values[:1]
	ax.plot(angles, values, colors[5], linewidth=1, linestyle='solid')
	...
	ax.text(-8, 13, 'FAIR-NN', rotation='vertical', color='gray')
	ax.text(-4, 9.5, r'$n=200$', va='center', ha='center', color='gray')
	ax.text(-4, 11.5, r'$n=500$', va='center', ha='center', color='gray')
	ax.text(-4, 13.5, r'$n=2000$', va='center', ha='center', color='gray')
	...
	axs[0].text(2, 0.58, r"$\hat{S}\neq S^\star$", va='center', ha='center', size=15)
	axs[1].text(2, 0.58, r"$8\in \hat{S}$", va='center', ha='center', size=15)
	axs[2].text(2, 0.58, r"$[5]\setminus\hat{S} \neq \emptyset$", va='center', ha='center', size=15)
